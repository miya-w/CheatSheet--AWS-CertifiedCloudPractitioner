...
| Service                | Purpose                                                                                      | Layer Protected                          | Key Features                                                                                                                                                                                                                               
|------------------------|----------------------------------------------------------------------------------------------|------------------------------------------|------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| AWS Shield             | DDoS protection                                                                              | Network and Transport (Layer 3/4)        | - Automatic protection against DDoS attacks <br> - Two tiers: Standard and Advanced <br> - Advanced provides near real-time attack visibility and access to AWS DDoS Response Team (DRT) -  Use Cases  : Protects against large-scale DDoS attacks <br> - Basic protection for all AWS services   Integration Points : Automatically integrated with AWS services like CloudFront, Route 53, and Elastic Load Balancing             |
